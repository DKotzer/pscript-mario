var oneone = (Mario.oneone = function () {
  ...
  level.putQBlock(16, 10, new Mario.Bcoin([256, 144]));
  level.putQBlock(16, 7, new Mario.Bcoin([256, 144]));
  level.putQBlock(16, 8, new Mario.Bcoin([256, 144]));
  level.putQBlock(16, 6, new Mario.Bcoin([256, 144]));
  level.putQBlock(16, 5, new Mario.Bcoin([256, 144]));

  level.putQBlock(17, 10, new Mario.Bcoin([256, 144]));
  level.putQBlock(17, 5, new Mario.Bcoin([256, 144]));
  level.putQBlock(18, 10, new Mario.Bcoin([256, 144]));
  level.putQBlock(18, 5, new Mario.Bcoin([256, 144]));
  level.putQBlock(19, 9, new Mario.Bcoin([256, 144]));
  level.putQBlock(19, 6, new Mario.Bcoin([256, 144]));
  level.putQBlock(19, 8, new Mario.Bcoin([256, 144]));
  level.putQBlock(19, 7, new Mario.Bcoin([256, 144]));


  //Y
    level.putQBlock(23, 9, new Mario.Bcoin([256, 144]));
    level.putQBlock(23, 10, new Mario.Bcoin([256, 144]));
    level.putQBlock(23, 7, new Mario.Bcoin([256, 144]));
    level.putQBlock(23, 8, new Mario.Bcoin([256, 144]));
    level.putQBlock(22, 6, new Mario.Bcoin([256, 144]));
    level.putQBlock(24, 6, new Mario.Bcoin([256, 144]));
    level.putQBlock(21, 5, new Mario.Bcoin([256, 144]));
    level.putQBlock(25, 5, new Mario.Bcoin([256, 144]));


  //L
  level.putQBlock(27, 9, new Mario.Bcoin([256, 144]));
  level.putQBlock(27, 10, new Mario.Bcoin([256, 144]));
  level.putQBlock(27, 7, new Mario.Bcoin([256, 144]));
  level.putQBlock(27, 8, new Mario.Bcoin([256, 144]));
  level.putQBlock(27, 6, new Mario.Bcoin([256, 144]));
  level.putQBlock(27, 5, new Mario.Bcoin([256, 144]));

  level.putQBlock(28, 10, new Mario.Bcoin([256, 144]));
  level.putQBlock(29, 10, new Mario.Bcoin([256, 144]));
  level.putQBlock(30, 10, new Mario.Bcoin([256, 144]));
